  ...
  return (
    <CRow className={props.className} xs={{ gutter: 4 }}>
      ...
      <CWidgetStatsA
        ...
        title={t('Total Products')}  // Translated to English
        // action={
        //   <CDropdown alignment="end">
        //     <CDropdownToggle color="transparent" caret={false} className="text-white p-0">
        //       <CIcon icon={cilOptions} />
    ...
    <CCol sm={6} xl={4} xxl={3}>
      <CWidgetStatsA
        ...
        title={t('Products Incoming in September')}  // Translated to English
        // action={
        //   <CDropdown alignment="end">
        //     <CDropdownToggle color="transparent" caret={false} className="text-white p-0">
        //       <CIcon icon={cilOptions} />
        ...
        //     <CDropdownMenu>
        //       <CDropdownItem>{t('View Details')}</CDropdownItem>  // Translated to English
        //       <CDropdownItem>{t('Add Incoming Item')}</CDropdownItem> // Translated to English
        //     </CDropdownMenu>
        //   </CDropdown>
        // }
        chart={
